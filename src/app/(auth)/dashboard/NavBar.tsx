...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="w-4/6 mx-auto border-b-2 border-transparent bg-gray-100 rounded-lg px-8 py-2">
      <nav className="flex  items-center justify-between">
        <Link
          className="mt-2 text-3xl flex items-center gap-2 font-semibold rounded-lg text-lime-600 bg-transparent focus:outline-none focus:shadow-outline"
