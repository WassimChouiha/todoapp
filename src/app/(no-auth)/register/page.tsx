...
export default function Register() {
  ...
  return (
    <div className="flex h-screen items-center sm:w-[420px]">
      <form
        className="w-full p-8 flex flex-col items-center sm:w-[85%]"
        onSubmit={handleSubmit(onSubmit)}
      >
        <div className="w-[33%] flex flex-col items-center bg-gray-100 rounded-lg py-4 sm:w-[55%] lg:w-[50%] md:w-[50%]">
          ...
          <div className="flex items-center sm:flex-col lg:flex-col">
            <Button className="bg-lime-500 hover:bg-lime-600" type="submit">
              Register
            </Button>
            <Link
              className="ml-24 text-lime-500 hover:text-lime-600 sm:hidden lg:hidden md:hidden"
              href="/login"
            >
